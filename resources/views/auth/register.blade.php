                    ...
                    <form class="" action="{{ url('register')  }}" method="post">
                        ...
                        <div class="block block-themed block-rounded block-shadow block-bordered">
                            <div class="block-header">
                                <h3 class="block-title font-size-lg">Create New Account  -  <small class="font-size-sm">We’re excited to have you on board!</small></h3>
                            </div>
                            <div class="block-content">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('last_name') is-invalid @enderror" id="signup-lastname" name="last_name" placeholder="eg. Doe" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="signup-email">Email</label>
                                        <input type="email" class="form-control" id="signup-email" name="email" placeholder="eg: john_doe@example.com" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12 col-md-6">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="password" class="form-control" id="signup-password-confirm" name="password_confirmation" placeholder="********" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 push">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="signup-terms">I agree to the <a href="#" class="link-effect" data-toggle="modal" data-target="#modal-terms"> Terms &amp; Conditions </a></label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 push">
