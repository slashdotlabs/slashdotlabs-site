        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title font-weight-bold">Terms &amp; Conditions  </h3>
                ...
                <div class="block-content">
                    <p><strong> Last updated: January 13, 2020</strong> </p>
                    ...
                    <ul>
                        ...
                        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Slash Dot Labs.</li>
                        ...
                        <li><strong>Website</strong> refers to Slash Dot Labs, accessible from slashdotlabs.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                    </ul>
                    ...
                    <ul>
                              <li>By visiting this page on our website: <a href="https://slashdotlabs.com/contact">Contact Us</a></li>
                    </ul>
                </div>
            </div>
...
<!-- END Terms Modal -->
 ...
 <!-- Privacy Modal -->
<div class="modal fade" id="modal-privacy" tabindex="-1" role="dialog" aria-labelledby="modal-terms" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-slidedown" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    <div class="block-header bg-primary-dark">
                        <h3 class="block-title font-weight-bold">Privacy Policy </h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                                <i class="si si-close"></i>
                            </button>
                    ...
                    <div class="block-content">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Slash Dot Labs.</p>
                            </li>
                            <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                            <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
                            <li><strong>Website</strong> refers to Slash Dot Labs, accessible from slashdotlabs.com</li>
                            <li><strong>Service</strong> refers to the Website.</li>
                            <li><strong>Country</strong> refers to: Kenya</li>
                            <li>
                        ...
                        <ul>
                            <li>By visiting this page on our website: https://slashdotlabs.com/contact/</li>
                        </ul>
                </div>
            </div>
            <div class="modal-footer">
