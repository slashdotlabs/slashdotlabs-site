            ...
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="block-content">
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Slash Dot Labs.
                        </li>
                        <li><strong>Country</strong> refers to: Kenya</li>
                        <li><strong>Service</strong> refers to the Website.</li>
                        <li>
                            <strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement is maintained by the
                            <a href="https://www.privacypolicies.com/terms-conditions-generator/">Terms and Conditions Generator</a>.
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By visiting this page on our website:
                            <a href="https://slashdotlabs.com/contact">Contact Us</a></li>
                    </ul>
                </div>
            </div>
