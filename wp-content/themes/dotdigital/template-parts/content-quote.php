...
//single item layout
if ( is_singular() ) : ?>
	<article id="post-<?php the_ID(); ?>" <?php post_class('vertical-item content-padding with_background overflow-hidden'); ?>>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class( 'ds vertical-item text-center content-padding big-padding ' . $additional_post_class ); ?>>
        ...
        <div class="item-content">
            ...
            <div class="entry-avatar">
				<?php
				global $post;
				echo get_avatar( $post->post_author, $size = 160 ); ?>
            </div>
            ...
            <div class="entry-meta text-center content-justify-center">
				...
				<?php endif; ?><!-- .entry-date -->
                <div class="format-name small-text"><?php echo esc_html__('Quote', 'dotdigital') ?></div>
            </div><!-- .entry-meta -->
