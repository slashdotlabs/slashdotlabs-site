...
$options = array(
	'title'              => array(
		...
		'desc'  => esc_html__( 'Optional Testimonials Title', 'dotdigital' ),
		'type'  => 'text',
	),
			...
			'testimonials_carousel'         => array(
				'testimonials' => array(
					...
					'popup-options' => array(
						...
						'author_job'    => array(
							'label' => esc_html__( 'Company', 'dotdigital' ),
							'desc'  => esc_html__( 'Can be used for a company description', 'dotdigital' ),
							'type'  => 'text'
						),
						'site_name'     => array(
