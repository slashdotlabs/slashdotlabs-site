...
<?php foreach ( $atts['headings'] as $heading ) : ?>
	<<?php echo esc_html( $heading['heading_tag'] ); ?> class="<?php echo( $heading['heading_tag'] !== 'p' ? 'section_header margin_0 ' : '' );  echo !empty( $heading['heading_custom_class']) ? $heading['heading_custom_class'] : ''; ?> <?php echo( $heading['heading_tag'] == 'p' ? 'paragraph' : '' ); ?>">
