...
class FW_Extension_Team extends FW_Extension {
	...
	public function _action_register_post_type() {
		...
		$post_names = apply_filters( 'fw_ext_team_post_type_name',
			array(
				'singular' => __( 'Team member', 'fw' ),
				'plural'   => __( 'Team members', 'fw' )
			) );

		register_post_type( $this->post_type,
			array(
				'labels'             => array(
					'name'               => $post_names['plural'], //__( 'Team', 'fw' ),
					'singular_name'      => $post_names['singular'], //__( 'Team member', 'fw' ),
				...
				'description'        => __( 'Create a team item', 'fw' ),
				'public'             => true,
				'show_ui'            => true,
				'show_in_menu'       => true,
	...
	public function _action_register_taxonomy() {
		...
		$labels = array(
			'name'              => sprintf( _x( 'Team %s', 'taxonomy general name', 'fw' ),
				$category_names['plural'] ),
			'singular_name'     => sprintf( _x( 'Team %s', 'taxonomy singular name', 'fw' ),
			...
			if ( $post_type === $this->post_type ) {
				...
				$options[] = array(
					'member_meta_tab' => array(
						'title'   => __( 'Member Meta', 'fw' ),
						'type'    => 'box',
						'options' => array(
							'tab_position' => array(
								'title'   => __( 'Member position', 'fw' ),
								'type'    => 'tab',
								'options' => array(
									'position' => array(
										'title'   => __( 'Member position name', 'fw' ),
										'type'    => 'text',
									)
								),
							),
							'tab_social_icons' => array(
								'title'   => __( 'Social links', 'fw' ),
								'type'    => 'tab',
								'options' => array(
									$member_social_icons,
								),
							...
							'tab_bio' => array(
								'title'   => __( 'Member Bio Tab', 'fw' ),
								'type'    => 'tab',
								'options' => array(
									'bio' => array(
										'type'  => 'wp-editor',
										'value' => '',
										'label' => __('Member Bio', 'fw'),
										'wpautop' => true,
							...
							'tab_skills' => array(
								'title'   => __( 'Skills Tab', 'fw' ),
								'type'    => 'tab',
								'options' => array(
									'skills' => array(
										'type'            => 'addable-box',
										'value'           => '',
										'label'           => esc_html__( 'Skills progress bars', 'fw' ),
										'desc'            => esc_html__( 'Display skills as a progress bar', 'fw' ),
										'template'        => '{{=title}}',
										'box-options'     => array(
											$member_skills,
										),
					...
					'additional_content_box' => array(
						'title'   => __( 'Below tabs content', 'fw' ),
						'type'    => 'box',
						'options'    => array(
							'additional_content' => array(
								'type'        => 'wp-editor',
								'value'       => '',
								'label'       => __( 'Text below member meta tabs', 'fw' ),
								'wpautop'     => true,
								'size'        => 'large',
								'editor_type' => false, // tinymce, html
							),
					...
					'team_slider_image' => array(
						'context' => 'side',
						'title' => __( 'Team Slider Image', 'fw' ),
						'type' => 'box',
						'options' => array(
							'slider_image' => array(
								'type' => 'upload',
								'label' => false,
								'desc' => __( 'Use only for Team Slider shortcode ', 'fw' )
							),
						)
					),
				);
